    ...
    IInvokedEventProducer producer)
{
    ...
    protected async Task<GeneralUser> Like(ILikable entity, EventType eventType, CancellationToken cancellationToken)
    {
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    protected async Task Dislike(ILikable entity, CancellationToken cancellationToken)
    {
        var currentUser = identityProvider.Current.User;
        ...
        await likeRepository.Delete(entity.Id, currentUser.UserId, cancellationToken);
    }
}