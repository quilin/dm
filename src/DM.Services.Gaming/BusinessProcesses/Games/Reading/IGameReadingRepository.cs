...
internal interface IGameReadingRepository
{
    ...
    /// <returns></returns>
    Task<int> Count(GamesQuery status, Guid userId, CancellationToken cancellationToken);
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    Task<IEnumerable<Game>> GetOwn(Guid userId, CancellationToken cancellationToken);
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    Task<Game> GetGame(Guid gameId, Guid userId, CancellationToken cancellationToken);
    ...
    /// <param name="cancellationToken"></param>
    /// <returns></returns>
    Task<GameExtended> GetGameDetails(Guid gameId, Guid userId, CancellationToken cancellationToken);
    ...
    /// </summary>
    /// <returns></returns>
    Task<IEnumerable<Game>> GetPopularGames(int gamesCount, CancellationToken cancellationToken);
}