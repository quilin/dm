...
namespace DM.Services.DataAccess.Migrations
{
    ...
    [Migration("20220114152946_TestUserData")]
    partial class TestUserData
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DM.Services.DataAccess.BusinessObjects.Users.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            UserId = new Guid("5be34a7d-22db-4768-b211-4dc7654e261c"),
                            AccessPolicy = 0,
                            Activated = true,
                            CanMerge = false,
                            Email = "admin@dm.am",
                            IsRemoved = false,
                            Login = "admin",
                            PasswordHash = "lUTrrT5dd82qIuamjL8cRRfxXpOa5Y/3ABUILuX+MRs=",
                            QualityRating = 0,
                            QuantityRating = 0,
                            RatingDisabled = false,
                            RegistrationDate = new DateTimeOffset(new DateTime(2022, 1, 14, 15, 29, 45, 588, DateTimeKind.Unspecified).AddTicks(8371), new TimeSpan(0, 0, 0, 0, 0)),
                            Role = 19,
                            Salt = "A8ZmMTaApByo5FqrDE+G3F7lYXCfvbFCBkuYmr4kkl0eVlHEvmm8IOECdc+KgxnMeeeLTscP1PJEIgRETKs508POLFd7XOOwS0oP",
                            Status = "My password is pwd_admin"
                        },
                        new
                        {
                            UserId = new Guid("b80c3ca4-8ccf-463b-a13d-b829da404fe4"),
                            AccessPolicy = 0,
                            Activated = true,
                            CanMerge = false,
                            Email = "player@dm.am",
                            IsRemoved = false,
                            Login = "player",
                            PasswordHash = "Es0VRSPBgkmTC7N/S5mNesFvn9e9c1bQEd/A7gt+6LA=",
                            QualityRating = 0,
                            QuantityRating = 0,
                            RatingDisabled = false,
                            RegistrationDate = new DateTimeOffset(new DateTime(2022, 1, 14, 15, 29, 45, 588, DateTimeKind.Unspecified).AddTicks(9176), new TimeSpan(0, 0, 0, 0, 0)),
                            Role = 1,
                            Salt = "HuuqgzvaET31lWiqqf11nkVXA18b3fx/aF93dTaLZnmIT63kFU8O1RRAi9pG7R9xERDVh+nkoiWaUqMp/RFyQRIBSjOcr9O8RuMD",
                            Status = "My password is pwd_player"
                        },
                        new
                        {
                            UserId = new Guid("ad89a190-1f46-4718-b929-af5dfc8acd1e"),
                            AccessPolicy = 0,
                            Activated = true,
                            CanMerge = false,
                            Email = "player_alt@dm.am",
                            IsRemoved = false,
                            Login = "player_alt",
                            PasswordHash = "Dg1QPgYLgM5Q67w/j5Jj/4z+Gzzk0Y3+jEnpkgkeqYY=",
                            QualityRating = 0,
                            QuantityRating = 0,
                            RatingDisabled = false,
                            RegistrationDate = new DateTimeOffset(new DateTime(2022, 1, 14, 15, 29, 45, 588, DateTimeKind.Unspecified).AddTicks(9248), new TimeSpan(0, 0, 0, 0, 0)),
                            Role = 1,
                            Salt = "3m7iJpyDBt3fuCKTlsLM8XdnuX8/0srof0/0qqmyNo7dzc6PazajxjuOPmZfUR9DCTlSO8xQ+b1r9i32LFLFsIP2HQtsaNxUV4+T",
                            Status = "My password is pwd_player_alt"
                        },
                        new
                        {
                            UserId = new Guid("060384bc-1001-4449-bd24-4db2e6de8773"),
                            AccessPolicy = 0,
                            Activated = true,
                            CanMerge = false,
                            Email = "moderator_general@dm.am",
                            IsRemoved = false,
                            Login = "moderator_general",
                            PasswordHash = "KbXOIktGkaTUETHU3w+7SrW7NvrUU/S/6AAgoJBZqTU=",
                            QualityRating = 0,
                            QuantityRating = 0,
                            RatingDisabled = false,
                            RegistrationDate = new DateTimeOffset(new DateTime(2022, 1, 14, 15, 29, 45, 588, DateTimeKind.Unspecified).AddTicks(9251), new TimeSpan(0, 0, 0, 0, 0)),
                            Role = 9,
                            Salt = "pXoay10W9EsX2jQZh6B6UyyDOHuqY5aXiTzLKfOGmNf9MH4J55KqVESCEDJGhqaZH5dFLTxib8Ga4nZAvU93VINJxztES0TN7/Bd",
                            Status = "My password is pwd_moderator_general"
                        },
                        new
                        {
                            UserId = new Guid("d01a4eb1-af59-4585-95fa-2c98696c35fa"),
                            AccessPolicy = 0,
                            Activated = true,
                            CanMerge = false,
                            Email = "nanny@dm.am",
                            IsRemoved = false,
                            Login = "nanny",
                            PasswordHash = "YdFyoApgb/ZEXbiPLzi45j5hY9M0yvexM3oqwDFfiNk=",
                            QualityRating = 0,
                            QuantityRating = 0,
                            RatingDisabled = false,
                            RegistrationDate = new DateTimeOffset(new DateTime(2022, 1, 14, 15, 29, 45, 588, DateTimeKind.Unspecified).AddTicks(9254), new TimeSpan(0, 0, 0, 0, 0)),
                            Role = 5,
                            Salt = "GfIyR4NZ03z9K40u+Rk0sWH59+krnd7dE22Y+kL7v7dulUV5Tvqeu27SDqjL/lYAaZmwsOz1A/Fx3HGs3fN+Zk0GPEtNeKOS6Scp",
                            Status = "My password is pwd_nanny"
                        });
                });
