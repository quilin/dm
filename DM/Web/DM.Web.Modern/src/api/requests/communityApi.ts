...
export default new class CommunityApi {
  ...
  public async uploadUserPicture(login: string, files: FormData, progressCallback: any) {
    return await Api.postFile<Envelope<User>>(`users/${login}/uploads`, files, progressCallback);
  }
